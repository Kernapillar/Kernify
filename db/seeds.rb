...
track2 = Track.create(name: "Otherside", duration: "1:00", album_id: 1, artist_id: 1)
    audio_file2 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track2.audio_url.attach(io: audio_file2, filename: 'Final_Recording_AK.mp3')
...
track4 = Track.create(name: "Easily", duration: "1:00", album_id: 1, artist_id: 1)
    audio_file4 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track4.audio_url.attach(io: audio_file4, filename: 'Final_Recording_AK.mp3')

track5 = Track.create(name: "Dani California", duration: "1:00", album_id: 2, artist_id: 1)
    audio_file5 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track5.audio_url.attach(io: audio_file5, filename: 'Final_Recording_AK.mp3')
...
track7 = Track.create(name: "Charlie", duration: "1:00", album_id: 2, artist_id: 1)
    audio_file7 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track7.audio_url.attach(io: audio_file7, filename: 'Final_Recording_AK.mp3')

track8 = Track.create(name: "Wet Sand", duration: "1:00", album_id: 2, artist_id: 1)
    audio_file8 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track8.audio_url.attach(io: audio_file8, filename: 'Final_Recording_AK.mp3')
...
track10 = Track.create(name: "So American", duration: "1:00", album_id: 3, artist_id: 2)
    audio_file10 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track10.audio_url.attach(io: audio_file10, filename: 'Final_Recording_AK.mp3')
track11 = Track.create(name: "Got It All (This Can't Be Living Now)", duration: "1:00", album_id: 3, artist_id: 2)
    audio_file11 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track11.audio_url.attach(io: audio_file11, filename: 'Final_Recording_AK.mp3')

track12 = Track.create(name: "All Your Light (Times Like These)", duration: "1:00", album_id: 3, artist_id: 2)
    audio_file12 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track12.audio_url.attach(io: audio_file12, filename: 'Final_Recording_AK.mp3')
track13 = Track.create(name: "Share With  Me the Sun", duration: "1:00", album_id: 3, artist_id: 2)
    audio_file13 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track13.audio_url.attach(io: audio_file13, filename: 'Final_Recording_AK.mp3')
...
track15 = Track.create(name: "People Say", duration: "1:00", album_id: 4, artist_id: 2)
    audio_file15 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track15.audio_url.attach(io: audio_file15, filename: 'Final_Recording_AK.mp3')
track16 = Track.create(name: "The Sun", duration: "1:00", album_id: 4, artist_id: 2)
    audio_file16 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track16.audio_url.attach(io: audio_file16, filename: 'Final_Recording_AK.mp3')
track17 = Track.create(name: "Do You", duration: "1:00", album_id: 4, artist_id: 2)
    audio_file17 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track17.audio_url.attach(io: audio_file17, filename: 'Final_Recording_AK.mp3')
...
track19 = Track.create(name: "Mornings", duration: "1:00", album_id: 4, artist_id: 2)
    audio_file19 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track19.audio_url.attach(io: audio_file19, filename: 'Final_Recording_AK.mp3')

    # Tycho
track20 = Track.create(name: "A Walk", duration: "1:00", album_id: 5, artist_id: 3)
    audio_file20 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track20.audio_url.attach(io: audio_file20, filename: 'Final_Recording_AK.mp3')
track21 = Track.create(name: "Dive", duration: "1:00", album_id: 5, artist_id: 3)
    audio_file21 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track21.audio_url.attach(io: audio_file21, filename: 'Final_Recording_AK.mp3')
track22 = Track.create(name: "Adrift", duration: "1:00", album_id: 5, artist_id: 3)
    audio_file22 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track22.audio_url.attach(io: audio_file22, filename: 'Final_Recording_AK.mp3')
...
track25 = Track.create(name: "Lasso", duration: "1:00", album_id: 6, artist_id: 4)
    audio_file25 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track25.audio_url.attach(io: audio_file25, filename: 'Final_Recording_AK.mp3')
track26 = Track.create(name: "Rome", duration: "1:00", album_id: 6, artist_id: 4)
    audio_file26 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track26.audio_url.attach(io: audio_file26, filename: 'Final_Recording_AK.mp3')
track27 = Track.create(name: "Countdown", duration: "1:00", album_id: 6, artist_id: 4)
    audio_file27 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track27.audio_url.attach(io: audio_file27, filename: 'Final_Recording_AK.mp3')
track28 = Track.create(name: "Girlfriend", duration: "1:00", album_id: 6, artist_id: 4)
    audio_file28 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/Final_Recording_AK.mp3')
    track28.audio_url.attach(io: audio_file28, filename: 'Final_Recording_AK.mp3')
