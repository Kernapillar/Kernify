...
track21 = Track.create(name: "Awake", duration: "1:00", album_id: 5, artist_id: 3)
...
track22 = Track.create(name: "Dive", duration: "1:00", album_id: 5, artist_id: 3)
...
track25 = Track.create(name: "Lasso", duration: "1:00", album_id: 6, artist_id: 4)
    audio_file25 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/lasso.mp3')
    track25.audio_url.attach(io: audio_file25, filename: 'lasso.mp3')
track26 = Track.create(name: "Rome", duration: "1:00", album_id: 6, artist_id: 4)
    audio_file26 = URI.open('https://kernify-seed.s3.us-west-1.amazonaws.com/rome.mp3')
    track26.audio_url.attach(io: audio_file26, filename: 'rome.mp3')
